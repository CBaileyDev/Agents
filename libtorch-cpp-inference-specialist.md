...
- **Modern alternatives**: AOTInductor (`torch.export` + `aoti_compile_and_package`, PyTorch 2.3+) replaces TorchScript for new pipelines. ONNX Runtime C++ is ~10 MB vs libtorch's >1 GB; supports CUDA/TensorRT/DML execution providers — usually preferred for a small policy
